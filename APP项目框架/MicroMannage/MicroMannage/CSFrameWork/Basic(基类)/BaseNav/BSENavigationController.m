...
- (void)setupNavigationBarTheme {
    ...
    //设置背景颜色
    [navBar setBarTintColor:HEXCOLOR(0x0CA5D7)];
...
-(void)setUpBackBtn:(UIViewController *)Controller
{
    ...
    LeftItem.frame = CGRectMake(0, 0, 12, 19);
    [LeftItem setBackgroundImage:[UIImage imageNamed:@"return"] forState:UIControlStateNormal];
