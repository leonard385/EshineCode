...
/**
 An instance of `ZHCAudioMediaViewAttributes` specifies the appearance configuration of a `ZHCAudioMediaItem`.
 Use this class to customize the appearance of `ZHCAudioMediaItem`.
 */
@interface ZHCAudioMediaViewAttributes : NSObject
/**
...
/**
 Initializes and returns a `ZHCAudioMediaViewAttributes` instance having the specified attributes.
 ...
 @return A new `ZHCAudioMediaViewAttributes` instance
 */
...
/**
 Initializes and returns a default `ZHCAudioMediaViewAttributes` instance.
