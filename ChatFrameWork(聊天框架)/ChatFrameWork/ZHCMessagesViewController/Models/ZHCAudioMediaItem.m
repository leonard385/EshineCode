...
@implementation ZHCAudioMediaItem


#pragma mark - Initialization

- (instancetype)initWithData:(NSData *)audioData audioViewAttributes:(ZHCAudioMediaViewAttributes *)audioViewAttributes
{
...
{
    return [self initWithData:audioData audioViewAttributes:[[ZHCAudioMediaViewAttributes alloc] init]];
}
...
- (instancetype)init
{
    return [self initWithData:nil audioViewAttributes:[[ZHCAudioMediaViewAttributes alloc] init]];
}
...
- (UIView *)mediaView
{
    if (self.audioData && self.cachedMediaView == nil) {
        ...
        [ZHCMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:playView isOutgoing:self.appliesMediaViewMaskAsOutgoing];
...
- (BOOL)isEqual:(id)object
{
    ...
    ZHCAudioMediaItem *audioItem = (ZHCAudioMediaItem *)object;
...
{
    ZHCAudioMediaItem *copy = [[[self class] allocWithZone:zone] initWithData:self.audioData
