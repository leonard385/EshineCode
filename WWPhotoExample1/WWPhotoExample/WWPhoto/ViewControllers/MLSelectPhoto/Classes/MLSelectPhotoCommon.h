...
#define DefaultNavbarTintColor [UIColor whiteColor]//UIColorFromRGB(0x2f3535)
#define DefaultNavTintColor   [UIColor colorWithRed:18.0/255.0 green:95.0/255.0 blue:249.0/255.0 alpha:1]
#define DefaultNavTitleColor  [UIColor blackColor]//UIColorFromRGB(0xd5d5d5)
