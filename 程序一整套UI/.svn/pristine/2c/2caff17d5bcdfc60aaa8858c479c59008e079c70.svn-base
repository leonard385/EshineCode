...
@interface MMTrainOfflineAllController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMTrainOfflineAllController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self OASetUpSubviews];
    // Do any additional setup after loading the view.
}

-(void)OASetUpSubviews{
