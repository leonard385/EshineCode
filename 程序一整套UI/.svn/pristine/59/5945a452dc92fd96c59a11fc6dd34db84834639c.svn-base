...
@interface MMTrainOfflineNorController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMTrainOfflineNorController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self ONSetUpSubviews];
    // Do any additional setup after loading the view.
}

-(void)ONSetUpSubviews{
