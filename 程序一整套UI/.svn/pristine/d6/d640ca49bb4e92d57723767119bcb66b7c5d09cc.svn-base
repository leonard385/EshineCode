...
-(YYLabel *)lableTitle{
    if(_lableTitle == nil){
        ...
        NSMutableAttributedString *text = [self RTGetAttributedStringUserName:@"柳叶叶" dateStr:@"17:55"];
        _lableTitle.attributedText = text;
    }
    return _lableTitle;
}
...
-(UIImageView *)logoImage{
    if(_logoImage == nil){
        ...
        _logoImage.layer.cornerRadius = 2.5f;
...
-(UIButton *)btnFunc{
    if(_btnFunc == nil){
        ...
        _btnFunc.layer.cornerRadius = 2.5f;
...
-(NSMutableAttributedString*)RTGetAttributedStringUserName:(NSString *)usr dateStr:(NSString *)date{
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc]initWithString:[NSString stringWithFormat:@"%@  %@",usr,date]];
    NSRange range0 = [[text string] rangeOfString:usr options:NSCaseInsensitiveSearch];
    
    [text yy_setFont:[UIFont systemFontOfSize:12] range:range0];
    [text yy_setColor:HEXCOLOR(0x333333) range:range0];
    
    NSRange range1 = [[text string] rangeOfString:date options:NSCaseInsensitiveSearch];
