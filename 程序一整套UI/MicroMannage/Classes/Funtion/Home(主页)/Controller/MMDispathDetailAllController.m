//
//  MMDispathDetailAllController.m
//  MicroMannage
//
...
@interface MMDispathDetailAllController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMDispathDetailAllController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MMDispathTaskDetailController *vc = [MMDispathTaskDetailController new];
