//
//  MMRankingActiveViewController.m
//  MicroMannage
//
...
@interface MMRankingActiveViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)MMRankingActiveHeadView *headView;
@property(nonatomic,strong)MMRankingTimeFooterView *footView;
@end

@implementation MMRankingActiveViewController
...
-(void)RASetUpSubviews{
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0,self.view.width,self.view.height - kNavigationBarAndStateBarHeight - 50.0f) style:UITableViewStylePlain];
