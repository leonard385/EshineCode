//
//  MMTrainDispathDoingController.m
//  MicroMannage
//
...
@interface MMTrainDispathDoingController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMTrainDispathDoingController
