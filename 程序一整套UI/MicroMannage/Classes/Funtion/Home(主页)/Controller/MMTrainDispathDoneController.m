//
//  MMTrainDispathDoneController.m
//  MicroMannage
//
...
@interface MMTrainDispathDoneController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMTrainDispathDoneController
