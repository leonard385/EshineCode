//
//  MMTrainDispathUndoController.m
//  MicroMannage
//
...
@interface MMTrainDispathUndoController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MMTrainDispathUndoController
