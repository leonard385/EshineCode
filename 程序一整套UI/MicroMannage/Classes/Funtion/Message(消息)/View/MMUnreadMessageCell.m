...
@implementation MMUnreadMessageCell

-(UILabel *)headImageView{
    if(_headImageView == nil){
        _headImageView = [UILabel new];
        _headImageView.backgroundColor = [UIColor orangeColor];
        _headImageView.layer.cornerRadius = 5.0f;
        _headImageView.layer.masksToBounds = YES;
        [_headImageView setTextColor:[UIColor whiteColor]];
        [_headImageView setFont:[UIFont systemFontOfSize:14.0f]];
        [_headImageView setTextAlignment:NSTextAlignmentCenter];
        _headImageView.text = @"蔡化";
    }
